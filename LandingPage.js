...
import logo from "../img/logo.jpg"; // ✅ Ensure logo.jpg is placed inside src/img/
      ...
      <header>
        ...
        <div className="top-bar">
          ...
          <div className="top-right">
            <label>Theme</label>
            <select onChange={() => setDarkMode(!darkMode)}>
              <option>Light</option>
              <option>Dark</option>
            </select>
        ...
        <div className="logo-section">
          <div className="logo-box">
            <img src={logo} alt="MCA Logo" className="mca-logo" />
            <div className="logo-text">
              <h2>MINISTRY OF CORPORATE AFFAIRS</h2>
              <p>GOVERNMENT OF INDIA</p>
              <span>EMPOWERING BUSINESS, PROTECTING INVESTORS</span>
            </div>
          </div>
        ...
        <nav className="nav-bar">
          ...
          >
            <button className="dropbtn">Additional Services ▾</button>
            {dropdownOpen && (
              <div className="dropdown-content">
                <a href="#">E-adjudication</a>
                <a href="#">Appeal</a>
                <a href="/eConsultationDashboard" className="active-item">
                  E-Consultation
                </a>
              ...
              <div className="row text-center">
                <div className="col-lg-4 col-md-6">
                  <div className="area-box color-white box-active">
                    ...
                    <h5><a href="#">Sentiment Classification</a></h5>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="area-box color-white">
                    ...
                    <h5><a href="#">Analytical Dashboard</a></h5>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="area-box color-white box-active">
                    ...
                    <h5><a href="#">Text Summarization</a></h5>
            ...
            <div className="grid-col-4 footer-top-29">
              ...
              <div className="footer-list-29 footer-2">
                <ul>
                  ...
                  <li><a href="#pages">AI Sentiment Engine Deployed</a><h5>by Admin</h5></li>
                  <li><a href="#pages">New Dashboard Launched</a><h5>by Admin</h5></li>
                  <li><a href="#pages">Policy Impact Insights</a><h5>by Admin</h5></li>
                </ul>
              </div>
              ...
              <div className="footer-list-29 footer-3">
                <div className="properties">
                  ...
                  <ul>
                    <li>
                      <p><span className="fa fa-map-marker"></span> Ministry of Corporate Affairs,<br />Delhi, India.</p>
                    </li>
                    <li>
